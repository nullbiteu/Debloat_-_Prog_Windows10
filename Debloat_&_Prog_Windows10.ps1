...
#
# 7Zip				Gratis ZIP Programm
# Attributechanger	Mit dem Attribute Changer können Sie verschiedene Eigenschaften von Ordnern und Dateien anpassen.
# Hwinfo			Kostenloses Windows-Diagnose-Tool, informiert Sie über die Hardware-Ausstattung Ihres PCs.
# Rufus				Rufus kopiert ISO-Images bootfähig auf einen USB-Stick.
#Putty				Mit dem Remote-Access-Werkzeug PuTTY lassen sich entfernte Systeme via SSH-, Telnet-, Rlogin- und serieller Verbindung - auch verschlüsselt - fernsteuern.
# Treesizefree		TreeSize Free ist ein kostenloser Festplattenmanager für Windows. Die Software zeigt die Größe von Verzeichnissen inklusive aller Unterordner an.
# Runasdate			RunAsDate ist ein kleines Dienstprogramm, mit dem man ein Programm (z.B. zeitlich beschränkte Testversionen) immer mit einem festgelegten Datum startet.
#					Dieses Dienstprogramm ändert nicht das aktuelle Systemdatum und die aktuelle Systemzeit Ihres Computers, sondern injiziert nur das Datum / Uhrzeit, die Sie in der 
#					gewünschten Anwendung angeben.
# Mpc-be			MPC-BE (für Media Player Classic - Black Edition) ist ein quelloffener und freier Mediaplayer und kann verschiedenste Video- und Musikformate abspielen.
# Irfanview			IrfanView ist ein einfacher, schneller und für die private Nutzung kostenloser Bildbetrachter.
# Anydesk			Software für Fernwartung und Fernzugriff.
# Skype				Software für Sprach- oder Videoanrufe.
# Eraser			Einfach zu bedienendes Gratis-Programm für die Datenvernichtung.
# Bleachbit			BleachBit ist ein open-source Reinigungstool zum Entfernen von Datenmüll und sicherem Löschen von obseleten Dateien.
# Autolt			AutoIt ist eine Software zum Ausführen von Skripten, mit denen hauptsächlich Abläufe unter Microsoft Windows automatisiert.
# WinSCP			WinSCP ist ein grafischer Open Source SFTP und FTP Client für Windows, der auch das alte SCP -Protokoll unterstützt.
# Python			Python als das Schweizermesser unter den Programmiersprachen.
# Notepadplusplus	Notepad++ ist ein freier Texteditor für Windows und kompatible Betriebssysteme.
#

"InstallieremeineProgramme", # --> Function!
#
"zip",
"attributechanger",
"hwinfo",
...
#
# Installation meiner Programme via Chocolatey
#
#Installation von Chocolatey
#
Function InstallieremeineProgramme {
...
# System-Tool	
Function zip {
Write-Output "Installiere 7zip"
choco install 7zip -y
}
Function attributechanger {
Write-Output "Installiere Attributechanger"
choco install attributechanger -y
}
Function hwinfo {
Write-Output "Installiere hwinfo"
choco install hwinfo -y
}
Function rufus {
Write-Output "Installiere rufus"
choco install rufus -y
}
Function putty {
Write-Output "Installiere putty"
choco install putty -y
}
Function treesizefree {
Write-Output "Installiere treesizefree"
choco install treesizefree -y
}
Function runasdate {
Write-Output "Installiere runasdate"
choco install runasdate -y
}
# Audio/Grafik/Video
Function mpc-be {
Write-Output "Installiere mpc-be"
choco install mpc-be -y
}
Function irfanview {
Write-Output "Installiere irfanview"
choco install irfanview -y
}
# Internet
Function anydesk {
Write-Output "Installiere anydesk"
choco install anydesk -y
}
Function skype {
Write-Output "Installiere skype"
choco install skype -y
}
# Sicherheit
Function eraser {
Write-Output "Installiere eraser"
choco install eraser -y
}		
Function bleachbit {
Write-Output "Installiere Bleachbit"
choco install bleachbit -y
}		
# Entwicklung
Function Autolt {
Write-Output "Installiere Autolt"
choco install autoit -y
}
Function WinSCP {
Write-Output "Installiere WinSCP"
choco install winscp -y
}
Function python {
Write-Output "Installiere python"
choco install python -y
}
Function notepadplusplus {
Write-Output "Installiere notepadplusplus"
choco install notepadplusplus -y
}

 Datenschutz - Wichtig: Telemetrie deaktivieren

# Diese Optimierung kann dazu führen, dass die Enterprise Edition keine Windows-Updates mehr erhält.
# In der Windows Update-Systemsteuerung wird dann die Meldung "Ihr Gerät ist gefährdet, weil es veraltet ist und wichtige Sicherheits- und Qualitätsupdates fehlen. 
# Wir bringen Sie wieder auf den richtigen Weg, damit Windows sicherer ausgeführt werden kann. Wählen Sie diese Schaltfläche, um loszulegen".
# Aktivieren Sie in diesem Fall die Telemetrie, führen Sie das Windows-Update aus und deaktiviere die Telemetrie erneut.
#
